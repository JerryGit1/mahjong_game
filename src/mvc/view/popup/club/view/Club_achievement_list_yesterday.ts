...
class Club_achievement_list_yesterday extends Base_view{
    ...
    protected cell_yesterday:Club_achievement_single_yesterday;//俱乐部战绩-昨日-cell
    ...
    //更新视图;
    public add_club_yesterday_list(info){
        var data=info.infos;
        //清空
        ...
        if(length>0){
            ...
            for(let i=0;i<length;i++){
                this.cell_yesterday=new Club_achievement_single_yesterday(data[i],this.userId);//战绩-昨日
                ...
                this.cell_yesterday.x=20+350*i;
