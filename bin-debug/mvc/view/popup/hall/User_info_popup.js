...
var User_info_popup = (function (_super) {
    __extends(User_info_popup, _super);
    function User_info_popup(user_info) {
        var _this = _super.call(this, true, true) || this;
        _this.EVENT = new Popup_event_model(); //事件常量
        _this.init_content(user_info);
        return _this;
    }
    //添加背景以及内容;
    User_info_popup.prototype.init_content = function (user_info) {
...
__reflect(User_info_popup.prototype, "User_info_popup");
//# sourceMappingURL=User_info_popup.js.map