 ...
 * 俱乐部昨日战绩-单条
 */
var Club_achievement_single_yesterday = (function (_super) {
    __extends(Club_achievement_single_yesterday, _super);
    function Club_achievement_single_yesterday(info, userId) {
    ...
    Club_achievement_single_yesterday.prototype.init_content = function (info, userId) {
    ...
    //牌桌回放;
    Club_achievement_single_yesterday.prototype.record_info = function () {
    ...
    //分享按钮回调;
    Club_achievement_single_yesterday.prototype.share_back = function (e) {
    ...
    // 格式化时间
    Club_achievement_single_yesterday.prototype.getTime = function (date) {
    ...
    // 补零方法
    Club_achievement_single_yesterday.prototype.addPreZero = function (num) {
        if (num < 10) {
            return '0' + num;
        }
        else {
    ...
    return Club_achievement_single_yesterday;
}(Base_view));
__reflect(Club_achievement_single_yesterday.prototype, "Club_achievement_single_yesterday");
//# sourceMappingURL=Club_achievement_single_yesterday.js.map