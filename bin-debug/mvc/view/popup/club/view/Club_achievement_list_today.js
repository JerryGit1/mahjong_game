...
//代开列表;
var Club_achievement_list_today = (function (_super) {
    __extends(Club_achievement_list_today, _super);
    function Club_achievement_list_today(data) {
    ...
    //没有数据时显示的白色底图
    Club_achievement_list_today.prototype.add_white_bg = function () {
    ...
    Club_achievement_list_today.prototype.init_content = function () {
        //列表-滚动
    ...
    //更新视图;
    Club_achievement_list_today.prototype.add_club_today_list = function (info) {
        var data = info.infos;
        //清空
        ...
        if (length > 0) {
            ...
            for (var i_1 = 0; i_1 < length; i_1++) {
                this.cell_today = new Club_achievement_single_today(data[i_1], this.userId); //战绩-今日
    ...
    //显示回放pop
    Club_achievement_list_today.prototype.play_back_info_pop = function (data) {
        this.v_to_v_dis_event(this.EVENT.base_popup.club_play_back_info, data);
    };
    //分享pop
    Club_achievement_list_today.prototype.share_pop = function () {
        this.v_to_v_dis_event(this.EVENT.base_popup.share);
    };
    return Club_achievement_list_today;
}(Base_view));
__reflect(Club_achievement_list_today.prototype, "Club_achievement_list_today");
//# sourceMappingURL=Club_achievement_list_today.js.map