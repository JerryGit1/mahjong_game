...
var Big_settle_view = (function (_super) {
    __extends(Big_settle_view, _super);
    function Big_settle_view(model) {
    ...
    //初始化view;
    Big_settle_view.prototype.init_view = function () {
        //用户头像;
    ...
    return Big_settle_view;
}(Base_view));
__reflect(Big_settle_view.prototype, "Big_settle_view");
//# sourceMappingURL=DJS_user_view.js.map