...
var Location_popup = (function (_super) {
    __extends(Location_popup, _super);
    function Location_popup(model) {
    ...
    Location_popup.prototype.init_view = function () {
    ...
    Location_popup.prototype.init_content = function () {
        //大层
        ...
        for (var i in this.model.user_info_list) {
            var head_view = new User_head_view();
    ...
    Location_popup.prototype.add_nickname_txt = function (head_view, nickname) {
...
__reflect(Location_popup.prototype, "Location_popup");
//# sourceMappingURL=Location_popup.js.map