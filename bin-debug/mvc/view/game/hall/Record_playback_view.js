...
//战绩回放cell;
var Record_playback_view = (function (_super) {
    __extends(Record_playback_view, _super);
    function Record_playback_view(data, cell_index) {
        var _this = _super.call(this) || this;
        _this.EVENT = new Popup_event_model(); //事件常量
        _this.cell_data = data;
        _this.cell_index = cell_index + 1;
        _this.init_content();
        return _this;
    }
    Record_playback_view.prototype.init_content = function () {
    ...
    //规则回调;
    Record_playback_view.prototype.rule_back_func = function () {
        if (this.tip_view) {
    ...
    //回放;
    Record_playback_view.prototype.player_back_func = function () {
    ...
    //分享;
    Record_playback_view.prototype.share_back_func = function () {
        /*
          *  roomId:房间ID
         * number:第几局
         * timer:当前时间
    ...
    return Record_playback_view;
}(Base_view));
__reflect(Record_playback_view.prototype, "Record_playback_view");
//# sourceMappingURL=Record_playback_view.js.map